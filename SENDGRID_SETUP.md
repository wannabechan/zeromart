...
Zero Mart 로그인 인증 코드는 **SendGrid (Twilio)**를 통해 발송됩니다.
...
2. **Create API Key** 클릭
3. **API Key Name**: `Zero Mart Production` (원하는 이름)
...
| `SENDGRID_FROM_NAME` | 발신자 이름 (예: `Zero Mart`) | 선택 (기본값: Zero Mart) |
